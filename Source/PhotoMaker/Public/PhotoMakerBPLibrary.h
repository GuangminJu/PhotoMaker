...
#include "PhotoMakerBPLibrary.generated.h"
...
class SStandaloneWindow;
class SCustomImage;

UCLASS()
class PHOTOMAKER_API UPhotoMakerBPLibrary : public UBlueprintFunctionLibrary
{
...
public:
	...
	static void AppendPointOnPhoto(UTexture2D* InTexture, FVector2D Point, FVector2D Edge0, FVector2D Edge1,
								   FColor Color = FColor::White);
